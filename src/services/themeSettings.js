...
const DEFAULTS = {
  ...
  brand_logos: {
    ...
    logos: [
      { name:'James Martin',     image_url:'/images/brands/james-martin.svg',     url:'/collections/vanities?brand=james-martin' },
      { name:'Kohler',           image_url:'/images/brands/kohler.svg',           url:'/collections/vanities?brand=kohler' },
      { name:'Moen',             image_url:'/images/brands/moen.svg',             url:'/collections/faucets?brand=moen' },
      { name:'Delta',            image_url:'/images/brands/delta.svg',            url:'/collections/faucets?brand=delta' },
      { name:'American Standard',image_url:'/images/brands/american-standard.svg',url:'/collections/vanities?brand=american-standard' },
    ],
  },
  categories_section: {
    enabled: true,
  ...
  trust_band: {
    enabled: true,
    stat1_value: '10,000+', stat1_label: 'Happy customers nationwide',
    stat2_value: '500+',    stat2_label: 'Premium products in stock',
  ...
  testimonials: {
    ...
    items: [
      { text: 'The vanity arrived exactly as described and looks absolutely stunning in our master bath. The free shipping saved us over $200.', author: 'Sarah M.', location: 'Atlanta, GA', rating: 5 },
      { text: "I was hesitant to buy a vanity online, but the quality exceeded my expectations. Customer support helped me pick the right size and the delivery was flawless.", author: 'James T.', location: 'Dallas, TX', rating: 5 },
      { text: "Third vanity I've bought from BVO. Every time the experience is seamless — great selection, competitive pricing, and they stand behind what they sell.", author: 'Maria R.', location: 'Phoenix, AZ', rating: 5 },
    ],
  },
  newsletter: {
    enabled: true,
    ...
    subtitle: 'Join 12,000+ homeowners who get early access to sales, new arrivals, and bathroom renovation inspiration.',
